...
public class OptionRequest extends DhcpOptionFactory.DhcpOption { // Concrete
																	// type is
																	// OptionRequest
	...
	public OptionRequest() // throws Exception
	{
		init();
	}
	...
	public int write(DataOutputStream ostream) throws IOException {
		...
		}
		{
			...
			header.length = ((short) requestedOptions.getSize());
		}
	...
	public int addToRequestedOptions(int val) {
		UI16Field valtmp	= new UI16Field();
		valtmp.value	= val;
		requestedOptions.add(valtmp);
		return requestedOptions.size();
	}
