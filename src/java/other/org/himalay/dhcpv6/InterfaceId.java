...
public class InterfaceId extends DhcpOptionFactory.DhcpOption { // Concrete type
																// is
																// InterfaceId
	...
	// opaqueData
	public ByteArray opaqueData;

	public InterfaceId() // throws Exception
	{
		init();
	}
	...
	private void init() {
		...
		opaqueData = new ByteArray();
		opaqueData.setSizeType("EXTERNAL");
	}
	...
	public int readNoHeader(DataInputStream istream) throws IOException {
		...
		// read opaqueData
		{
			...
			opaqueData.setSize(iRead);
			retVal += opaqueData.read(istream);
		}
	...
	public int write(DataOutputStream ostream) throws IOException {
		...
		}
		{
			...
			header.length = ((short) opaqueData.getSize() - (0));
		}
		...
		// write opaqueData
		{
			retVal += opaqueData.write(ostream);
		}
		postWrite();
		return retVal;
	}
	...
	public int dump(DumpContext dc) throws IOException {
		...
		dc.indent();
		dc.getPs().print(
				"opaqueData: " + opaqueData.getSize() + "(0x"
						+ Integer.toHexString(opaqueData.getSize()) + ")\n");
		this.opaqueData.dump(dc);
		dc.decreaseIndent();
		return retVal;
	}
	...
	// public ByteArray getOpaqueData()
	// {
	// return opaqueData ;
	// }

	// Setter for opaqueData
	// public void setOpaqueData(ByteArray val)
	// {
	// this.opaqueData= val;
	// }

	public void setOpaqueData(byte[] val) {
		this.opaqueData.setData(val);
	}
